        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="box box-bordered">
                    ...
                    <div class="box-title" >
                        <h3> Import Hospitals Areas<i class="icon-th-list"></i></h3>	
                    </div>
...
{
  $data = array();
	function add_property($name,$zone,$area)
	{
		global $data;
		$data []= array(
        'name' => $name,
...
echo $user_id=$db->insert_sql("insert institutions(name,typeId,areaId,class) values('".trim($row["name"])."','2','$areaId','A')");
 $db->print_last_query();

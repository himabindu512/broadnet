...
<div class="page-header">
    <div class="pull-left" >
        <h1 style="font-size:4vw;">Salesman Dashboard</h1>
    </div>
...
<h3>
<i class="icon-bar-chart"></i>
<a href="#" style="color: #fff;" >Pharmacies By Class Report</a>
</h3>
<div class="actions">
<a class="btn btn-mini content-slideUp" href="#"><i class="icon-angle-down"></i></a>
</div>
...
<?
@$total=$db->select_one("select count(*) from reports where faildVisit=0 and typeId=3 and medRepId='".@$_SESSION['CMSuserID']."' and visitDate between '$date_start' and '$date_end'");
$Acount = $db->select_one("select count(*) from reports where faildVisit=0 and medRepId='".@$_SESSION['CMSuserID']."' and typeId=3 and institutionId in (select id from institutions where typeId=3 and class='A') and visitDate between '$date_start' and '$date_end'");
$Bcount = $db->select_one("select count(*) from reports where faildVisit=0 and medRepId='".@$_SESSION['CMSuserID']."' and typeId=3 and institutionId in (select id from institutions where typeId=3 and class='B') and visitDate between '$date_start' and '$date_end'");
$Ccount = $db->select_one("select count(*) from reports where faildVisit=0 and medRepId='".@$_SESSION['CMSuserID']."' and typeId=3 and institutionId in (select id from institutions where typeId=3 and class='C') and visitDate between '$date_start' and '$date_end'");
$BLcount = $db->select_one("select count(*) from reports where faildVisit=0 and medRepId='".@$_SESSION['CMSuserID']."' and typeId=3 and institutionId in (select id from institutions where typeId=3 and class='BL') and visitDate between '$date_start' and '$date_end'");
?>
...
<div class="box-title">
<h3>
<i class="icon-table"></i>Active Advocates List
</h3>
</div>
<div class="box-content nopadding">
<table class="table table-hover table-nomargin dataTable table-bordered dataTable-scroll-y dataTable-scroll-x" id="active_deal_table">
<thead>
<tr>
<th>ID</th>
<th>Doctor Name</th>

        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="box box-bordered">
                    ...
                    <div class="box-title" >
                        <h3> Import Clinic<i class="icon-th-list"></i></h3>	
                    </div>
...
echo $user_id=$db->insert_sql("insert institutions(name,typeId,areaId,class,specialityId) values('".trim($row["name"])."','4','$areaId','A','".$specialityId."')");
 $db->print_last_query();
